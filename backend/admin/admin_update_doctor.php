            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            $doc_number=$_GET['doc_number'];
                            $ret="SELECT  * FROM his_docs WHERE doc_number=? LIMIT 1";
                        ...
                        <?php 
                                ...
                                // No matching record found, you can display a message here
                                echo "No record found with doc_number = $doc_number";
                            }
                            $stmt->close();
                            $mysqli->close();
