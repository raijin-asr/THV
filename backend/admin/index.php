                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/login logo.png" alt="" height="22"></span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Login to Access Admin Panel.</p>
                                </div>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary btn-block" name="admin_login" type="submit"> Login as Admin</button>
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="admin_register.php" class="text-black ml-1"><b>Sign Up</b></a>
