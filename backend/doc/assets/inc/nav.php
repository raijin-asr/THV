<?php
    ...
    $doc_number = $_SESSION['doc_email'];
    $ret="SELECT * FROM  his_docs WHERE doc_id = ? AND doc_email = ?";
    ...
    <div class="navbar-custom">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- <div class="dropdown-header noti-title">
                        <h6 class="text-overflow m-0">Welcome to THV!</h6>
                    </div> -->
        ...
        <div class="logo-box">
            <a href="admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/logo big.png" alt="" height="18">
                </span>
                <span class="logo-sm">
