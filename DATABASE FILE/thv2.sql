...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2023 at 09:25 PM
...
(1, 'System', 'Admin', 'admin@gmail.com', '4c7f5919e957f354d57243d37f223cf31e9e7181', 'doc-icon.png');
...
INSERT INTO `his_docs` (`doc_id`, `doc_fname`, `doc_lname`, `doc_mobile`, `doc_addr`, `doc_email`, `doc_pwd`, `doc_dept`, `doc_number`, `doc_dpic`) VALUES
(5, 'Govinda', 'KC', '9800847392', 'Kathmandu', 'govinda@gmail.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Laboratory', 'GOV123', 'defaultimg.jpg'),
(6, 'Sanduk', 'Ruit', '9876556643', 'Bhaktapur', 'sanduk@gmail.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Surgery | Theatre', 'SAN123', 'user-default-2-min.png');
...
CREATE TABLE `his_patients` (
  ...
  `pat_solution` varchar(500) NOT NULL,
  `pat_pic` varchar(100) NOT NULL,
  `pat_pic1` varchar(100) DEFAULT NULL,
  `pat_pic2` varchar(100) DEFAULT NULL,
  `pat_pic3` varchar(100) DEFAULT NULL,
  `pat_pic4` varchar(100) DEFAULT NULL,
  `prob_description` varchar(400) NOT NULL,
  `prob_condition` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `his_patients` (`pat_id`, `pat_fname`, `pat_lname`, `pat_email`, `pat_pwd`, `pat_dob`, `pat_age`, `pat_number`, `pat_addr`, `pat_phone`, `pat_type`, `pat_date_joined`, `pat_ailment`, `pat_status`, `pat_solution`, `pat_pic`, `pat_pic1`, `pat_pic2`, `pat_pic3`, `pat_pic4`, `prob_description`, `prob_condition`) VALUES
(8, 'KP', 'Oli', 'kp@gmail.com', '55c3b5386c486feb662a0785f340938f518d547f', '02/02/1992', '30', 'KP123', 'Jhapa', '9876543212', 'InPatient', '2023-10-10 19:03:45.537300', 'Fever', 'Pending', '', 'user-default-2-min.png', '../patients/assets/images/users/usric.png', NULL, NULL, NULL, 'High Fever because of Weather Changes', 'Medium'),
(9, 'Durga', 'Prasai', 'durga@gmail.com', '55c3b5386c486feb662a0785f340938f518d547f', '01/19/1990', '32', 'DP123', 'Birjung', '9812456712', 'InPatient', '2023-10-10 18:19:37.228864', 'Malaria', 'Solved', 'Eat Healthy', 'defaultimg.jpg', 'malaria.webp', NULL, NULL, NULL, 'Malaria bitten by Mosquitos.', 'Critical'),
(10, 'Rishi', 'Dhamala', 'rishi@gmail.com', '55c3b5386c486feb662a0785f340938f518d547f', '10/11/2000', '22', 'RD123', 'Kathmandu', '9823415665', 'InPatient', '2023-10-10 18:19:32.134691', 'Diarrhoea', 'Pending', '', 'defaultimg.jpg', 'diarrhoea.webp', NULL, NULL, NULL, 'Diarrhoea because of Eating Junk Foods', 'Normal');
